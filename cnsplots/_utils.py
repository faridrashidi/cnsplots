...
def palettes(color):
    if isinstance(color, list):
        ...
        if color == "Set1":
            ...
            return sns.color_palette(colors)
        elif color == "RdBu_custom":
            # A diverging colormap from blue to white to red.
            # The middle color is a light gray, which appears white-ish.
            # Sourced from palettable.colorbrewer.diverging.RdBu_11_r
            cm_data = [
                [0.7057, 0.0156, 0.1503],
                [0.7406, 0.3151, 0.2905],
                [0.7785, 0.3887, 0.3250],
                [0.8143, 0.4608, 0.3582],
                [0.8477, 0.5312, 0.3906],
                [0.8785, 0.5995, 0.4228],
                [0.9063, 0.6654, 0.4550],
                [0.9308, 0.7283, 0.4877],
                [0.9515, 0.7876, 0.5213],
                [0.9678, 0.8423, 0.5562],
                [0.9790, 0.8912, 0.5925],
                [0.9845, 0.9328, 0.6305],
                [0.9838, 0.9647, 0.6698],
                [0.9769, 0.9839, 0.7084],
                [0.9547, 0.9733, 0.7224],
                [0.9160, 0.9652, 0.7634],
                [0.8727, 0.9486, 0.8088],
                [0.8277, 0.9248, 0.8526],
                [0.7815, 0.8954, 0.8916],
                [0.7350, 0.8618, 0.9239],
                [0.6887, 0.8248, 0.9490],
                [0.6429, 0.7851, 0.9667],
                [0.5977, 0.7432, 0.9769],
                [0.5533, 0.6994, 0.9797],
                [0.5096, 0.6539, 0.9753],
                [0.4666, 0.6069, 0.9634],
                [0.4243, 0.5587, 0.9442],
                [0.3830, 0.5094, 0.9173],
                [0.3428, 0.4588, 0.8837],
                [0.3038, 0.4065, 0.8444],
                [0.2662, 0.3528, 0.8000],
                [0.2298, 0.2987, 0.7537],
            ]
            return mpl.colors.LinearSegmentedColormap.from_list("RdBu_custom", cm_data)
